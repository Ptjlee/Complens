            ...
            <header className="border-b border-[#1e2336] bg-[#0c0f1a]/80 backdrop-blur-md sticky top-0 z-50">
                <div className="max-w-7xl mx-auto px-4 lg:px-8 h-16 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2 text-sm text-[#4ade80] bg-[#142323] px-3 py-1.5 rounded-full border border-[#1b3a31]">
                        <CheckCircle2 size={16} /> Anfrage genehmigt
                    </div>
                </div>
            </header>
            ...
            <main className="max-w-5xl mx-auto px-4 py-12 lg:py-20 grid lg:grid-cols-2 gap-12 lg:gap-20">
                ...
                <div className="space-y-8">
                    ...
                    <div className="aspect-video bg-[#141829] rounded-2xl border border-[#1e2336] shadow-xl overflow-hidden relative group">
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/40 backdrop-blur-[2px]">
                            ...
                            <span className="text-white font-medium mt-4">Klicken, um das Briefing anzusehen</span>
                        </div>
                    </div>
                    ...
                    <div className="grid sm:grid-cols-2 gap-6">
                        <div className="bg-[#141829] p-5 rounded-2xl border border-[#1e2336]">
                            ...
                            <h3 className="font-semibold text-white mb-2">Automatisiertes Mapping</h3>
                            <p className="text-sm text-[#a1a1aa]">Wir importieren Daten nahtlos aus SAP/Workday und ordnen Jobtitel automatisch zu.</p>
                        </div>
                        <div className="bg-[#141829] p-5 rounded-2xl border border-[#1e2336]">
                ...
                <div className="bg-[#141829] rounded-3xl border border-[#1e2336] shadow-2xl overflow-hidden flex flex-col">
                    <div className="p-8 border-b border-[#1e2336]">
                        <h2 className="text-xl font-bold text-white mb-2">Buchen Sie Ihren EU-Entgelttransparenz-Audit</h2>
                        <p className="text-sm text-[#a1a1aa]">Buchen Sie einen 30-minütigen technischen Deep Dive mit unserem Commercial Director, um die Plattform live auf Ihrem Datenschema zu sehen.</p>
                    </div>
                    ...
                    <div className="flex-1 p-8 flex items-center justify-center bg-[#070911]">
                        ...
                        <div className="text-center max-w-sm">
                            ...
                            <h3 className="text-[#a1a1aa] font-medium mb-4">Kalender-Widget lädt...</h3>
                            <p className="text-xs text-[#6e7185] mb-6">
                                Bitte betten Sie hier in der Produktion Ihre echte Calendly- oder Cal.com-URL als iFrame ein.
                            </p>
                            <a 
